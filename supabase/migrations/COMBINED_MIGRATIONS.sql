-- Combined migrations for Interactive Link project
...
-- ============================================
-- MIGRATION 2: Project Files Storage Bucket
-- ============================================
...
-- Check if user_sequences table was created
SELECT EXISTS (
  SELECT FROM information_schema.tables 
  WHERE table_schema = 'public' 
  AND table_name = 'user_sequences'
) as user_sequences_exists;
